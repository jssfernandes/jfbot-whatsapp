...
module.exports = {
    ...
    obterCartasContraHu : async()=>{
        try {
            let github_gist_cartas = await axios.get("https://gist.githubusercontent.com/jssfernandes/847cf69ab20dfb1361d3342177d6617a/raw/49bda956750ba38857e2fd48a7c123539873e420/cartas.json")
    ...
    obterInfoDDD: async(DDD)=>{
        try {
            const githubGistDDD= await axios.get("https://gist.githubusercontent.com/jssfernandes/847cf69ab20dfb1361d3342177d6617a/raw/4611eb11e9bf09f23698ebdfa44dcabcfe6feea4/ddd.json")
    ...
    obterTabelaNick: async()=>{
        const githubGistTabela = await axios.get("https://gist.githubusercontent.com/jssfernandes/847cf69ab20dfb1361d3342177d6617a/raw/c6799031b166630c32dd8e51ea2f418f133f0a6e/tabela.txt")
        return githubGistTabela.data
    },

    obterDestravas: async()=>{
        const githubGistDestravas = await axios.get("https://gist.githubusercontent.com/jssfernandes/847cf69ab20dfb1361d3342177d6617a/raw/de8d0d4ab95a56083ca51ebf5d6fb49a83b5743a/destravas.txt")
